  ...
  class DRbSSLSocket < DRbTCPSocket
    ...
    class SSLConfig
      ...
      def setup_certificate
        ...
        @certs = @pkey_algs.map { |pkey_alg| generate_certificate(pkey_alg) }
      end
      ...
      def setup_ssl_context
        ...
        # @certs is nil if :SSLCertificates, :SSLCertificate and :SSLPrivateKey
        # are all unset in #initialize.
      ...
      def generate_certificate(pkey_alg)
