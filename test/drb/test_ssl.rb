...
class TestSSLConfig < Test::Unit::TestCase
  ...
  # Test setup_ssl_context with :SSLClientSignatureAlgorithms config option.
  def test_setup_ssl_context_client_sigalgs
    # #setup_ssl_context requires OpenSSL::SSL::SSLContext#client_sigalgs=
    # introduced on Ruby OpenSSL >= 4.0.
    ctx_class = OpenSSL::SSL::SSLContext
  ...
  # Test setup_ssl_context with :SSLClientSignatureAlgorithms config option.
  # Similar to test_setup_ssl_context_client_sigalgs but with ML-DSA and RSA
  # multiple certificates for the PQC migration use case.
  ...
  # Test setup_ssl_context with :SSLGroups config option.
  def test_setup_ssl_context_groups
    # #setup_ssl_context requires OpenSSL::SSL::SSLContext#groups= introduced
    # (renamed) on Ruby OpenSSL >= 4.0.
    ctx_class = OpenSSL::SSL::SSLContext
  ...
  # Test setup_ssl_context with :SSLGroups config option.
  # Similar to test_setup_ssl_context_groups but with PQC supported ML-KEM
  # for the PQC use case.
